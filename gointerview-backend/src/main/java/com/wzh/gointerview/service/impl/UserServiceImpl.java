...
import static com.wzh.gointerview.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public QueryWrapper<User> getQueryWrapper(UserQueryRequest userQueryRequest) {
        ...
        String subId = userQueryRequest.getSubId();
        ...
        queryWrapper.eq(StringUtils.isNotBlank(subId), "subId", subId);
